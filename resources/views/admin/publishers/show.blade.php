...
@prepend('breadcrumbs')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><a href="/admin/publishers">Penerbit</a></li>
                ...
                <div class="card card-primary">
                    <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-2 text-center mb-3 mb-md-0">
                                        <img src="https://via.placeholder.com/150x100.png/{{ substr(uniqid(), -3) }}?text={{ urlencode(strtok($publisher->name, ' ')) }}"
                                            alt="{{ $publisher->name }}" class="img-fluid"
                                    ...
                                    <div class="col-md-4 pt-md-3">
                                        <dl class="row">
                                            ...
                                            <dd class="col-sm-8">{{ count($publisher->books) }}</dd>
                                        </dl>
                                    </div>
                                    <div class="col-md-4 pt-md-3">
                                        <dl class="row">
                                            ...
                                            <dd class="col-sm-8">
                                                {{ date('d-m-Y, H:i', strtotime($publisher->created_at)) }}</dd>
                                            <dt class="col-sm-4">Updated at</dt>
                                            <dd class="col-sm-8">
                                                {{ date('d-m-Y, H:i', strtotime($publisher->updated_at)) }}</dd>
                                        </dl>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if (count($publisher->books) != 0)
                            <h4 class="mt-4 mb-3">Semua buku dalam Penerbit {{ $publisher->name }}</h4>
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            <div class="form-group col-12">
                                <label for="name" class="form-label">Nama Penerbit <span
