                    ...
                    <div class="callout callout-{{ $colors[array_rand($colors)] }}">
                        <div class="row">
                            <div class="col-12 col-md-2 text-center mb-3 mb-md-0">
                                <a href="/admin/publishers/{{ $publisher->id }}">
                            ...
                            <div class="col d-flex align-items-center">
                                <a href="/admin/publishers/{{ $publisher->id }}" class="text-decoration-none">
                                    <h5 class="mb-0">{{ $publisher->name }}</h5>
                                    <p class="text-muted mt-2">Total {{ $publisher->books->count() }} Buku</p>
                                </a>
                            </div>
                        </div>
                    </div>
