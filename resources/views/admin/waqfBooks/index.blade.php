...
@prepend('breadcrumbs')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Buku Wakaf</li>
    </ol>
@endprepend
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <table id="waqfBooks" class="table table-bordered table-striped">
                            <thead>
                            ...
                            <tbody>
                                @foreach ($books as $book)
                                    <tr>
                                        ...
                                        <td class="align-middle" style="display: -webkit-box;
                                        -webkit-line-clamp: 3;
                                        -webkit-box-orient: vertical;
                                        overflow: hidden;
                                        text-overflow: ellipsis;">{{ $book->title }}</td>
                                        <td class="align-middle">{{ $book->waqif }}</td>
                                        <td class="align-middle">{{ $book->prodi }}</td>
                                        <td class="text-center align-middle">
                                            {{ date('d M Y', strtotime($book->tanggal_validasi)) }}
                                        </td>
